...
function number(id) {
    ...
    {  
        ...
        document.getElementById("ElN").value = document.getElementById("El").value;
        document.getElementById("MaN").value = document.getElementById("Ma").value;
    }
    else
    {
        document.getElementById("At").value = document.getElementById("AtN").value;
